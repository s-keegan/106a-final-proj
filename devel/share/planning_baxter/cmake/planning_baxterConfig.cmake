...
if("TRUE" STREQUAL "TRUE")
  set(planning_baxter_SOURCE_PREFIX /home/cc/ee106a/fa17/class/ee106a-abi/ros_workspaces/Fall-17-106A-Project/src/planning_baxter)
  set(planning_baxter_DEVEL_PREFIX /home/cc/ee106a/fa17/class/ee106a-abi/ros_workspaces/Fall-17-106A-Project/devel)
  ...
  set(planning_baxter_INSTALL_PREFIX /home/cc/ee106a/fa17/class/ee106a-abi/ros_workspaces/Fall-17-106A-Project/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'planning_baxter' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ee106a-abi <ee106a-abi@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'planning_baxter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa17/class/ee106a-abi/ros_workspaces/Fall-17-106A-Project/src/planning_baxter/${idir}'.  Ask the maintainer 'ee106a-abi <ee106a-abi@todo.todo>' to fix it.")
    endif()
